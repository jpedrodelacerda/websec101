...
|---------|--------|
|http://127.0.0.1/ | IPv4 |
|http://0x07f.1/ | Hexadecimal no primeiro octeto concatenado com o resto |
|http://017700000001/ | valor octal com 0-prefixed |
...
### Caractéres
   ...
   * Não reservados: <kbd>alfanuméricos</kbd> <kbd>-</kbd> <kbd>.</kbd> <kbd>_</kbd> <kbd>~</kbd>
   > Nota:
   > caractéres não reservados são permitidos apenas em escape. Estão relacionados a ataques de Engenharia Social.
...
### URL Relativa
  * <kbd>esquema válido:</kbd> + <kbd>//</kbd> -> URL absoluta
  * herdam 
